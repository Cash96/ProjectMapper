...
export function DeleteFeatureButton({
  ...
  return (
    <>
      <button
        type="button"
        className="control-button-secondary border-[rgba(187,77,63,0.22)] text-[#9f3d32] hover:bg-[rgba(187,77,63,0.08)]"
      ...
      {open ? (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-[rgba(21,34,48,0.42)] p-4" onClick={() => setOpen(false)}>
          <div className="surface-card-strong w-full max-w-xl rounded-[1.5rem] p-5 sm:p-6" onClick={(event) => event.stopPropagation()}>
            ...
            <h2 className="mt-2 text-xl font-semibold tracking-tight text-[var(--ink-950)]">Delete feature topic</h2>
            <p className="mt-3 text-sm leading-7 text-[var(--ink-700)]">
              This will permanently delete {featureName}, including Repo 1 studies, Repo 2 studies, mapping summaries, and saved guidance for this topic.
            </p>
